...
public record CreateProductRequest(
    ...
    [Range(0, double.MaxValue)] decimal MediumPrice,
    [Range(0, double.MaxValue)] decimal LastPrice,
    [Range(0, double.MaxValue)] decimal? SellingPrice,
    [Range(0, int.MaxValue)] int? InitialStock,
    [Range(0, int.MaxValue)] int? InitialShopStock,
    [Range(0, int.MaxValue)] int? InitialWarehouseStock,
